...
const FormProducto = () => { 
    ...
    // const [ FormProducto, serFormProducto] = useState([]);
    ...
    const guardarProducto = async (event) => {
        ...
        try {
            ...
            const respuesta = await ProductosServicios.guardarProducto(producto);
        ...
        <form className="container">
            ...
            <div className="row">
                <div className="mb-3 col-4">
                    <label htmlFor="nombre" className="form-control-sm">Ingrese nombre1</label>
